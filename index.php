...
<div class="welcome">
	<br><br>
	<h1>Welcome to SOB India</h1><br><br><br>
	<h1 style="color: white; font-weight: bold;">Sell Your Old Books Here</h1>
	<ul>
		<a href="admin/login.php" style="text-decoration: none; color: black;"><li>
			Log in
		</li></a>
		<a href="admin/register.php" style="text-decoration: none; color: black;"><li>Signup</li></a>
	</ul>
</div>
<div class="cont">
	...
	<ul>
                ...
                ?>
		<li><div class="post_img"><img src="admin/images/<?php echo $img; ?>"></div>
			<div class="title"><?php echo substr($title,0 , 30); ?>...</div>
			<div class="price">Price: <?php echo $price; ?>/-</div>
			<div class="details"><a href="book_info.php?id=<?php echo $id; ?>"><button type="button" class="btn btn-primary">View</button></a></div>
		</li>
	<?php } ?>
